# Postmortem Backtest — 2026-07-16

**Reports parsed**: 132 (NEW format only)
**With price outcome**: 132
**Window coverage**: 132/132 have ≥5d, 129/132 have ≥10d, 111/132 have ≥20d
...
|---|---:|:---:|:---:|:---:|:---:|:---:|
| `BUY` | 43 | +12.51% | +3.03% | +7.92% | -4.73% | +19.44% |
| `HOLD` | 56 | +8.89% | +2.64% | +5.23% | -9.06% | +21.63% |
| `SELL` | 2 | +21.14% | +13.62% | +18.22% | +2.01% | +24.25% |
...
|---|---:|:---:|:---:|:---:|:---:|
| `3` | 5 | -7.96% | -3.36% | -6.42% | -15.08% |
| `4` | 64 | +11.79% | +1.48% | +7.12% | -7.53% |
| `5` | 21 | +3.15% | +3.16% | +3.05% | -9.68% |
...
| Bucket | N | ret_so_far | ret_5d | ret_10d | min_close_pct |
|---|---:|:---:|:---:|:---:|:---:|
| `30-50_neutral_dn` | 5 | -4.42% | +1.27% | -2.85% | -11.94% |
| `50-70_neutral_up` | 40 | +8.39% | +2.91% | +6.71% | -6.21% |
| `70-90_strong` | 33 | +20.09% | +3.71% | +10.65% | -4.26% |
...
| `News>=3 only` | 17 | +15.32% | +1.64% | +9.54% | -6.12% |
| `RSI>=90 only` | 4 | +19.28% | +7.09% | +8.14% | -0.51% |
| `neither` | 48 | +13.17% | +4.22% | +8.85% | -5.11% |
...
**Filled aggressive entries**: 5 / 132
...
|---|---:|---:|
| final_score | +0.198 | 126 |
| raw_score | -0.385 | 11 |
| Fundamentals | +0.105 | 98 |
| Sentiment | +0.136 | 97 |
| News | +0.141 | 98 |
| Technical | +0.024 | 98 |
| Burry score | -0.002 | 86 |
| RT strength (inverted: -x) | +0.027 | 90 |
...
|---|---:|---:|---:|---:|
| BUY | 43 | +12.51% | +11.62% | +6.40% |
| HOLD | 56 | +8.89% | +8.73% | +2.46% |
| SELL | 2 | +21.14% | — | +21.14% |
...
| 2026-06-21 | PLTR | SELL | -0.48 | — | — | n | +12.4% | Y | +19.0% |
...
| 2026-07-08 | MU | — | +0.38 | — | — | n | — | n | — |
| 2026-07-08 | NVDA | — | +0.40 | — | — | n | — | n | — |
| 2026-07-08 | PLTR | — | +0.01 | — | 50 | n | — | n | — |
