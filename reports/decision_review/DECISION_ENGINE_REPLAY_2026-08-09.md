# Decision Engine Replay — 2026-08-09
...
| 分類 | 筆數 |
|---|---|
| history trades 總數 | 178 |
| replayed（current rules） | 6 |
...
| 2026-08-09 | NOW | `calculation_steps` | +1.0616 | +1.0616 | +0.0000 | STAGED_ENTRY | STAGED_ENTRY | ✓ match |
| 2026-08-09 | PLTR | `calculation_steps` | +0.5165 | +0.5165 | +0.0000 | HOLD | HOLD | ✓ match |
