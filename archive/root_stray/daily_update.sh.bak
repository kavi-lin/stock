...
# ── Step 1｜廣度數據 ─────────────────────────────────────────
echo "[ 1/7 ]  市場廣度分析（TraderMonty CSV）..."
...
echo "[ 4/7 ]  FRED 宏觀數據更新（利率 / 通膨 / 就業 / 信用）..."
...
echo "[ 5/7 ]  整合所有 cache → Dashboard/data.json..."
python3 bridge.py
...
echo "[ 6/7 ]  Thematic Screener — Tactical Opportunity Radar..."
...
echo "[ 7/7 ]  Structural Watchlist — V2.19 結構性轉變候選..."
set +e
