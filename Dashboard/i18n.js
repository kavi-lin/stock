const i18n = {
  zh: {
    ...
    momentum: {
      ...
      preset_leaders:  { label: "🚀 真動能領航者", tip: "分數 ≥ 75 + Stage 2 上升趨勢 + 量能比 1.2x+ + 僅熱門產業。四重共振，精選最強領頭羊。" },
  ...
  en: {
    ...
    momentum: {
      ...
      preset_leaders:  { label: "🚀 Momentum Leaders", tip: "Score 75+ / Stage 2 / Volume 1.2x+ / Hot Sector only. Four-way confluence — the strongest leaders right now." },
